...
second_hand_length = 190
hand_thickness = 4

# Load the clock face image
clock_image = pygame.image.load("mickey_clock.jpeg")
...
while True:
    ...
    # Calculate the position of the clock face image so that it's centered on the screen
    clock_position = (int((clock_size[0] - clock_image.get_width()) / 2), int((clock_size[1] - clock_image.get_height()) / 2))

    # Draw the clock face image
    ...
    pygame.draw.line(screen, (255, 0, 0), clock_position[0] + clock_center[0], clock_position[1] + clock_center[1], clock_position[0] + minute_hand_end[0], clock_position[1] + minute_hand_end[1], hand_thickness)

    # Draw the second hand
    pygame.draw.line(screen, (0, 255, 0), clock_position[0] + clock_center[0], clock_position[1] + clock_center[1], clock_position[0] + second_hand_end[0], clock_position[1] + second_hand_end[1], hand_thickness)
